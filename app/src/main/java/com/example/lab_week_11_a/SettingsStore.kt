...
import androidx.datastore.preferences.core.Preferences // Pastikan ini Preferences dari DataStore
...
// Gunakan delegasi ini di level top-level (di luar class)
...
class SettingsStore(private val context: Context) {
    ...
    companion object {
        // PERBAIKAN: Tipe datanya bukan String?, tapi Preferences.Key<String>
